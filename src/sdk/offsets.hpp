...
// --- UNSERE EIGENEN NETVARS ---
namespace netvars {
    constexpr std::ptrdiff_t m_hPlayerPawn = 0x90C;  // Dein ursprünglicher Wert war richtig!
    ...
    constexpr std::ptrdiff_t m_pGameSceneNode = 0x338;  // C_BaseEntity
